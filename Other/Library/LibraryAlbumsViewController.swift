...
class LibraryAlbumsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setUpNoAlbumsView()
        fetchData()
        observer = NotificationCenter.default.addObserver(forName: .albumSavedNotificaton, object: nil, queue: .main, using: { [weak self] _ in
            self?.fetchData()
        })
    ...
    private func setUpNoAlbumsView() {
        ...
        noAlbumsView.configure(with: ActionLabelViewModel(text: "You dont have any saved albums yet", actionTitle: "Browse"))
